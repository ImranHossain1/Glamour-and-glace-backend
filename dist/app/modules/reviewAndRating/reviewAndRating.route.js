...
router.post('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.CLIENT), (0, validateRequest_1.default)(reviewAndRating_validation_1.ReviewAndRatingValidation.create), reviewAndRating_controller_1.ReviewAndRatingController.insertIntoDB);
